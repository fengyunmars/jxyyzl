...
public class FlyPopWindowCard extends PopupWindow implements View.OnClickListener {
    ...
    public FlyPopWindowCard(Context mContext, View.OnClickListener mListener, OnDismissListener mDismissListener) {
        super();
    ...
    private void initView() {
        View view = LayoutInflater.from(mContext).inflate(R.layout.list_item_sp_pop1, null);
        setContentView(view);
        setFocusable(true);
        setTouchable(true);
